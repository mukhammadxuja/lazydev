export const Rounded = () => {
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <button
        type="button"
        className="btn rounded-full bg-transparent dark:bg-gray-800 dark:hover:bg-slate-800 dark:border-gray-700 border-2 border-blue-300 hover:border-blue-600 dark:hover:border-gray-500 text-blue-600 dark:text-white">
        White
      </button>
      <button
        type="button"
