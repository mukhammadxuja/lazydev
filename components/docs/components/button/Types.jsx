export const Types = () => {
  return (
    <div className="flex flex-wrap items-center">
      ...
      <button
        type="button"
        className="btn bg-transparent dark:bg-transparent border-2 border-blue-300 hover:border-blue-600 dark:border-gray-600 dark:hover:border-gray-500 text-blue-600 dark:text-white mx-1 md:mx-2 my-1 md:my-2">
        White
      </button>
      <button
        type="button"
