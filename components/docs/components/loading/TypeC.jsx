...
export const TypeC = () => {
  ...
  return (
    <div className="flex flex-col items-center space-y-4">
      <div className="border-t-transparent w-[40px] h-[40px] border-4 border-[#1a5cff] border-double rounded-full animate-spin" />
      ...
      <div
        ...
        <div className="border-t-transparent w-[50px] h-[50px] border-4 border-[#1a5cff] border-double rounded-full animate-spin" />
      </div>
    </div>
  );
};
