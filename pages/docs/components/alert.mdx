      ...
      <div className="p-4 rounded-lg bg-white shadow-lg dark:bg-[#102a43] w-[20rem] md:w-[25rem] my-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <h4 className="text-gray-700 dark:text-white font-semibold">
              Uploaded Successful
            </h4>
          </div>
          <div>
...
<ComponentExample name="Icon with Button" paragraph="This is a paragraph" space="space-y-2">
  ...
  <IconWithButton
    ...
    buttonStyle="btn bg-[#ff4757] dark:bg-[#ff4757] text-xs md:text-sm text-white hover:drop-shadow-2xl hover:-translate-y-1"
    text="Something went wrong"
    paragraph="... do not uploaded"
  />
</ComponentExample>
