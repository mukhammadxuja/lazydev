...
<Code>
  ...
  <button
    type="button"
    className="hover:underline rounded-xl py-2 px-4 md:py-3 md:px-6 bg-transparent text-blue-600
...
<Code>
  ...
  <button
    type="button"
    className="hover:underline py-2 px-4 md:py-3 md:px-6 bg-transparent text-blue-600
    active:text-blue-400">
    Link
  </button>
  ````
