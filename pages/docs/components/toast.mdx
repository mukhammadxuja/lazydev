...
export const Glassmorphism = () => {
  return (
    <>
      <div className="relative z-20 flex items-center w-[20rem] md:w-[25erm] bg-white shadow-lg dark:bg-darkSecondary p-5 rounded-xl bg-opacity-50 backdrop-filter backdrop-blur-sm">
